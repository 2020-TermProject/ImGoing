...
public class SearchResult {
    ...
    public SearchResult(String restaurantName, String ownerName, String category, String restaurantLongitude, String restaurantLatitude, String reservedSeat , String availableSeat){
